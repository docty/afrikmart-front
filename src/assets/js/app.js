!(function (a) {
    ...
    a("#side-menu").metisMenu(),
        ...
        window.sessionStorage && ((s = sessionStorage.getItem("is_visited")) ? (a(".right-bar input:checkbox").prop("checked", !1), a("#" + s).prop("checked", !0), t(s)) : sessionStorage.setItem("is_visited", "light-mode-switch")),
